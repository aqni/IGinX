...
sed -i "" "s/your-token/testToken/" core/target/iginx-core-${VERSION}/conf/config.properties

sed -i "" "s/your-organization/testOrg/" core/target/iginx-core-${VERSION}/conf/config.properties

sed -i "" "s/storageEngineList=127.0.0.1#6667/#storageEngineList=127.0.0.1#6667/" core/target/iginx-core-${VERSION}/conf/config.properties

sed -i "" "s/#storageEngineList=127.0.0.1#8086/storageEngineList=127.0.0.1#8086/" core/target/iginx-core-${VERSION}/conf/config.properties
