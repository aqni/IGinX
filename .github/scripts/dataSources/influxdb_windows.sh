...
sed -i "s/your-token/testToken/g" core/target/iginx-core-${VERSION}/conf/config.properties

sed -i "s/your-organization/testOrg/g" core/target/iginx-core-${VERSION}/conf/config.properties

sed -i "s/storageEngineList=127.0.0.1#6667/#storageEngineList=127.0.0.1#6667/g" core/target/iginx-core-${VERSION}/conf/config.properties

sed -i "s/#storageEngineList=127.0.0.1#8086/storageEngineList=127.0.0.1#8086/g" core/target/iginx-core-${VERSION}/conf/config.properties
