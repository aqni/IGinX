...
sh -c "sed -i 's/#storageEngineList=127.0.0.1#6667#iotdb12/storageEngineList=127.0.0.1#6667#iotdb12/g' core/target/iginx-core-${VERSION}/conf/config.properties"
